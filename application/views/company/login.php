                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form class="mt-4 pt-2" method="POST" >
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input type="tel" class="form-control" name="number" id="input-username" placeholder="Enter Contact Number" maxlength="10">
                                            <label for="input-username">Contact Number</label>
